package br.com.leevelop.admin.catalog.infrastructure.category;
...
import br.com.leevelop.admin.catalog.infrastructure.category.persistence.CategoryJpaEntity;
...
public class CategoryMySQLGatewayTest {
    ...
    public void givenPrePersistedCategoriesAndMaisAssistidaAsTerms_whenCallsFindAllAndTermsMatchsCategoryDescription_shouldReturnPaginated() {
        ...
        Assertions.assertEquals(expectedTotal, actualResult.total());
        Assertions.assertEquals(expectedPerPage, actualResult.items().size());
        Assertions.assertEquals(filmes.getId(), actualResult.items().getFirst().getId());
    }
