package br.com.leevelop.admin.catalog.e2e.category;

import br.com.leevelop.admin.catalog.E2ETest;
...
import br.com.leevelop.admin.catalog.infrastructure.category.persistence.CategoryRepository;
import br.com.leevelop.admin.catalog.infrastructure.configuration.json.Json;
...
public class CategoryE2ETest {
    ...
    public void asACatalogAdminIShouldNotSeeAnErrorByDeletingANotExistentCategory() throws Exception {
        ...
        this.mvc.perform(delete("/categories/" + CategoryID.from("12313")))
                .andExpect(status().isNoContent());
    ...
    private CategoryID givenACategory(final String aName, final String aDescription, final boolean isActive) throws Exception {
        ...
        final var aRequestCall = post("/categories")
                .contentType(MediaType.APPLICATION_JSON)
                .content(Json.writeValueAsString(aRequestBody));

        final var actualId = Objects.requireNonNull(this.mvc.perform(aRequestCall)
