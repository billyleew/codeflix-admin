...
import br.com.leevelop.admin.catalog.domain.validation.handler.ThrowsValidationHandler;
...
public class CategoryTest {
    ...
    public void givenAnInvalidNameLengthMoreThan255_whenCallNewCategoryAndValidate_thenShouldReceiveError() {
        final var expectedName = """
                 Acima de tudo, é fundamental ressaltar que a utilização de SSL nas transações comerciais acarreta um processo de reformulação e modernização dos requisitos mínimos de hardware exigidos. Por outro lado, a complexidade computacional exige o upgrade e a atualização das ACLs de segurança impostas pelo firewall.
                """;
        final var expectedDescription = "A categoria mais assistida";
        final var expectedIsActive = true;
